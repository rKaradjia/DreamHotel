...
class AppKernel extends Kernel
{
    public function registerBundles()
    {
        $bundles = [
            ...
            new DREAMHOTEL\AccueilBundle\DREAMHOTELAccueilBundle(),
          //  new DREAMHOTELChambresBundle\DREAMHOTELChambresBundle(),
            new DREAMHOTEL\ChambresBundle\DREAMHOTELChambresBundle(),
